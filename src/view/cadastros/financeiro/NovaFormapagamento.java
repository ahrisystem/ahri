...
public class NovaFormapagamento extends javax.swing.JFrame {
    FormapagamentoController fc = new FormapagamentoController();
    String pesquisaAtual;
    
    private static final NovaFormapagamento INSTANCIA = new NovaFormapagamento();
    
    public static NovaFormapagamento getInstancia() {
        return INSTANCIA;
    }
    
    private NovaFormapagamento() {
        initComponents();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (txtCodigo.getText().equalsIgnoreCase("")) {
            ...
            if (txtNome.getText().equalsIgnoreCase("")) {
                ...
                fm.setCod(Integer.parseInt(txtCodigo.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovaFormapagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovaFormapagamento().setVisible(true);
            }
        });
    }
