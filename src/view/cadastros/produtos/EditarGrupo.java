...
public class EditarGrupo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxServico.setText("Grupo de serviços?");
        cbxServico.setToolTipText("Será um grupo de serviços?");
        ...
        painelPrincipal.add(cbxServico, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, 170, 20));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (txtNome.getText().equalsIgnoreCase("")) {
            ...
            if (sldTipo.getValue()==0) {
                ...
                pm.setPai(Integer.parseInt(txtPai.getSelectedItem().toString()));
            }
            pm.setTipo(sldTipo.getValue());
