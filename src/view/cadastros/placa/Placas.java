...
public class Placas extends javax.swing.JPanel {
    private static final Placas INSTANCIA = new Placas();
    PlacaController pl = new PlacaController();
    
    public static Placas getInstancia() {
        return INSTANCIA;
    }
    ...
    private void btnEditarMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMouseReleased
        if (tabela.getSelectedRow()<0) {
            ...
            EditarPlaca edit = EditarPlaca.getInstancia();
    ...
    private void btnExcluirMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExcluirMouseReleased
        if (tabela.getSelectedRow()<0) {
            ...
            if (JOptionPane.showConfirmDialog(null, "Deseja mesmo excluir?",
                ...
                pl.excluir(tabela.getValueAt(tabela.getSelectedRow(), 0).toString());
                listar();
            }
        }
    ...
    private void btnExcluidosMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExcluidosMouseReleased
        new RegistrosExcluidos("Placas excluídas").setVisible(true);
