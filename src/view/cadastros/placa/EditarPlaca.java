...
public class EditarPlaca extends javax.swing.JFrame {
    PesquisarController pc = new PesquisarController();
    PlacaController pl = new PlacaController();
    private static final EditarPlaca INSTANCIA = new EditarPlaca();

    public static EditarPlaca getInstancia() {
        return INSTANCIA;
    }
    ...
    public void puxarDados(String cod){
        ...
        txtCodigo.setText(em.getCod());
        int codigocliente = 0;
        if (em.getCodcliente() == 0) {
            
        } else {
            codigocliente = em.getCodcliente();
            txtCliente.setText(Integer.toString(codigocliente));
        }
        txtNome.setText(em.getNome());
        txtCliente2.setText(em.getNomecliente());
        txtTipo.setSelectedItem(em.getDetalhes());
        txtDetalhes.setText(em.getDetalhes());
    }
    ...
    private void initComponents() {
        ...
        painelPrincipal.add(btnDescartar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, -1, 30));
        ...
        painelPrincipal.add(btnSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 240, 160, 30));
        ...
        if (JOptionPane.showConfirmDialog(null, "Salvar alterações?", "Salvar?", opcao) == 0) {
            if (txtCodigo.getText().equalsIgnoreCase("") || txtCodigo.getText().length() > 8) {
                ...
                if (txtNome.getText().equalsIgnoreCase("")) {
                    ...
                    pl.alterar(em, txtCodigo.getText());
                    limpaCampos();
                    this.dispose();
                }
            }
    ...
    public static void main(String args[]) {
        ...
        } catch (ClassNotFoundException ex) {java.util.logging.Logger.getLogger(EditarPlaca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {java.util.logging.Logger.getLogger(EditarPlaca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {java.util.logging.Logger.getLogger(EditarPlaca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (javax.swing.UnsupportedLookAndFeelException ex) {java.util.logging.Logger.getLogger(EditarPlaca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);}
        //</editor-fold>
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarPlaca().setVisible(true);
            }
        });
    }
