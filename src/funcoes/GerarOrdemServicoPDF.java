...
public class GerarOrdemServicoPDF {
     ...
     */
    public static void Orcamento(OrdemdeServicoModel vm, boolean exibirProdutos, boolean exibirPlaca, List<VendasItensModel> p) {
        PdfWriter writer;
        try {
    ...
    public static void main(String[] args) {
        OrdemdeServicoModel vm = new OrdemdeServicoModel();
